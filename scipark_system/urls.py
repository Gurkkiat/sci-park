...
urlpatterns = [
    ...
    # Timeline Management
    path('projects/<str:project_id>/timeline/add/', views.project_add_timeline, name='project_add_timeline'),
    path('projects/timeline/<int:timeline_id>/edit/', views.project_edit_timeline, name='project_edit_timeline'),
    path('projects/timeline/<int:timeline_id>/delete/', views.project_delete_timeline, name='project_delete_timeline'),
